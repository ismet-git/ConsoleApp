...
namespace ConsoleApp
{
    public class MiniHeap
    {
        ...
        */
        ...
        //{
        //    Console.WriteLine("Mini Heap started ... ");
        //    MinHeap mh = new MinHeap();
        //    mh.add(17);
        //    Console.WriteLine("added 17 ... ");            
        //    Console.WriteLine("peek: " + mh.peek());

        //    mh.add(34);
        //    Console.WriteLine("added 34 ... ");
        //    Console.WriteLine("peek: " + mh.peek());
        ...
        public class MinHeap
        {
            ...
            ************************************************/
            ...
            private void ensureExtraCapacity()
            {
                if (size == capacity)
                {
                    //heap = Arrays.copyOf(heap, capacity * 2); // Java
                    Array.Resize<int>(ref heap, capacity * 2); // C#
                    capacity *= 2;
                }
            }
